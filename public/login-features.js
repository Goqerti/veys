document.addEventListener('DOMContentLoaded', async () => {
    ...
    const mascotBubble = document.getElementById('loginMascotBubble');
    ...
    // --- YENİ İSTİFADƏÇİ YARATMA MODALI ÜÇÜN KOD (YENİLƏNİB) ---
    ...
    if (createUserModal) {
        ...
        registrationForm.addEventListener('submit', async (e) => {
            ...
            const userData = {
                ...
                role: roleValue,
                department: document.getElementById('regDepartment').value // YENİ: Şöbə dəyəri əlavə edildi
            };
